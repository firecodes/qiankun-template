<template>
  <section class="main-content">
    <StatusCard :countSentMessages="model?.countSentMessages" :countPendingMessages="model?.countPendingMessages" />
    <MessagesChart :subscribers="model?.subscribers" :messages="model?.messages" />
