...
<script setup lang="ts">
  ...
  const columns: ColumnDef<Payment>[] = [
    ...
    },
    {
      accessorKey: "english",
      header: "English",
      cell: ({ row }) => h("div", { class: "capitalize" }, row.getValue("english")),
    },
    {
      accessorKey: "khmer",
      header: "Khmer",
      cell: ({ row }) => h("div", { class: "capitalize" }, row.getValue("khmer")),
    },
    {
      accessorKey: "chinese",
      header: "Chinese",
      cell: ({ row }) => h("div", { class: "capitalize" }, row.getValue("chinese")),
    },
    {
      id: "actions",
      enableHiding: false,
