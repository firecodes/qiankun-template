<template>
  <div>
    ...
    <el-timeline style="max-width: 600px">
      <el-timeline-item v-for="(activity, index) in paginatedActivities" :key="index" :icon="activity.icon"
    ...
    <el-pagination class="absolute bottom-15" layout="prev, pager, next" :total="activities.length" :page-size="4"
