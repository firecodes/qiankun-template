    ...
    <ConfigProvider locale={zhCN} space={{ size: CONFIG.APP_CONTENT_SPACE_SIZE }}>
      <Layout id="app-layout" className={styles.appLayout}>
        ...
        <Layout style={{ marginLeft: siderWidth.value, display: 'block' }}>
          {/* <Layout.Header  style={{ width: `calc(100% - ${siderWidth.value}px)` }}  className={styles.appHeader}  >
          ...
          <Layout.Footer className={styles.appFooter}>
            <Space size="small">
              <Icon.CodeOutlined /> Powered by
              <Typography.Link target="_blank" href="https://github.com/facebook/react"> React
              </Typography.Link>  &
              <Typography.Link target="_blank" href="https://github.com/veactjs/veact"> Veact
              </Typography.Link>
            </Space>
          </Layout.Footer>
        </Layout>
