module.exports = {
  ...
  rules: {
    ...
    "key-spacing": 0,//[0, { beforeColon: false, afterColon: true }], //对象字面量中冒号的前后空格
    "lines-around-comment": 0, //行前/行后备注
    "max-depth": [0, 4], //嵌套块深度
    "max-len": [0, 80, 4], //字符串最大长度
    "max-nested-callbacks": [0, 0], //回调嵌套深度
    "max-params": [0, 3], //函数最多只能有3个参数
    "max-statements": 0,// [0, 00], //函数内最多有几个声明
    ...
    quotes: 0, //引号类型 `` "" ''
    "quote-props": 0,//[0, "always"], //对象字面量中的属性名是否强制双引号
    radix: 0, //parseInt必须指定第二个参数
    "id-match": 0, //命名检测
    "require-yield": 0, //生成器函数必须有yield
    semi: 0, //语句强制分号结尾
    "semi-spacing": 'off', //分号前后空格
    "sort-vars": 0, //变量声明时排序
    "space-after-keywords": 0,// [0, "always"], //关键字后面是否要空一格
    "space-before-blocks": 0,//[0, "always"], //不以新行开始的块{前面要不要有空格
    "space-before-function-paren": 0,// [0, "always"], //函数定义时括号前面要不要有空格
    "space-in-parens": 0,//[0, "never"], //小括号里面要不要有空格
    "space-infix-ops": 0, //中缀操作符周围要不要有空格
    "space-return-throw-case": 0, //return throw case后面要不要加空格
    "space-unary-ops": 0, // [0, { words: true, nonwords: false }], //一元运算符的前/后要不要加空格
    ...
    "wrap-iife": 0,// [0, "inside"], //立即执行函数表达式的小括号风格
